...
var createNewTaskElement=function(taskString){
    ...
    editButton.classList.add("main__button', main__button_delete")
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("_mode_edit");
    //If class of the parent is ._mode_edit
    if(containsClass){

        //switch to ._mode_edit
    ...
    //toggle ._mode_edit on the parent.
    listItem.classList.toggle("_mode_edit");
};
